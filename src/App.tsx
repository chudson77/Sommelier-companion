...
const App: React.FC = () => {
  ...
  // FIX: Refactored to correctly handle async operations, loading state, and error handling.
  // The previous implementation had a race condition where `setIsLoading(false)` was called prematurely
  // and errors from the Gemini API were not being caught.
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 flex flex-col items-center">
        {!imageFile && (
          <div className="w-full max-w-2xl text-center">
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-4 text-gray-100">Discover Your Wine's Story</h2>
